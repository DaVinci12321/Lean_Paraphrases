...
- **Lean Workbook** — Ying et al., *Lean Workbook: A Large-scale Lean Problem Set Formalized from Natural Language Math Problems*, arXiv:2406.03847. License: **Apache 2.0** (`internlm/Lean-Workbook` on Hugging Face).
- **Enumerate-Conjecture-Prove / Constructive Bench** — Sun et al., arXiv:2505.18492. License: **MIT** (`sunjia72/ConstructiveBench` on Hugging Face).
- **DeepSeek-Prover / Prover Bench** — Xin et al., arXiv:2405.14333. The `deepseek-ai/DeepSeek-ProverBench` dataset on Hugging Face carries no explicit license tag of its own; the parent DeepSeek-Prover-V1.5/V2 code repositories are **MIT**-licensed, but that covers the code, not necessarily the ProverBench data file. Treat its license as unconfirmed and check with the DeepSeek team before redistributing.
- **FormalMATH** — Yu et al., *FormalMATH: Benchmarking Formal Mathematical Reasoning of Large Language Models*, arXiv:2505.02735. License: **MIT** (`SphereLab/FormalMATH-All` on Hugging Face).
